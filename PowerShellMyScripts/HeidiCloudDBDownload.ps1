...
$listName="HeidiKanyoDB"  
$currentTime= $(get-date).ToString("yyyyMMddHHmmss")  
$logFilePath="\\Sv05121a\e\C 作業台\RPA\ALLDataBase\BU\Log\Heidi関与先DBCloud\"+$currentTime+".txt"  
...
{  
    ...
    {  
        ...
        $outputFilePath="\\Sv05121a\e\C 作業台\RPA\ALLDataBase\Heidi関与先DBCloud.csv"  
