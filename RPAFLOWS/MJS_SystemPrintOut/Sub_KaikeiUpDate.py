        ...
        if str(Exc.row_kanyo_no) == ThisNo:
            ...
            if Exc.PN == "消費税確定申告書":
                ...
                while (
                    ...
                    SCQ = RPA.ImgCheck(URL, r"\ScountQ.png", 0.9, 10)
                    if SCQ[0] is True:
                        pg.press("n")  # nでいいえ
                    # 基本情報登録誘導ウィンドウがひょうじされたら
                    KKS = RPA.ImgCheck(URL, r"\KihonKoushin.png", 0.9, 10)
                    if KKS[0] is True:
                ...
                if KKS[0] is False:
                    ...
                    while (
                        ...
                        time.sleep(1)
                        SIQ = RPA.ImgCheck(URL, r"\SiwakeInputQ.png", 0.9, 10)
                        if SIQ[0] is True:
                            pg.press("y")
                        # 再計算確認ウィンドウがあるか確認
                        RCQ = RPA.ImgCheck(URL, r"\ReCalcQ.png", 0.9, 10)
                        if RCQ[0] is True:
                            pg.press("n")
                        # 消費税不明取引確認ウィンドウがあるか確認
                        KN = RPA.ImgCheck(URL, r"\S_Humei.png", 0.9, 10)
                        if KN[0] is True:
                            pg.press("y")
                        DIN = RPA.ImgCheck(URL, r"\Din.png", 0.9, 10)
                        if DIN[0] is True:
                            pg.press("y")
                    # --------------------------------------------------------------------
                    time.sleep(1)
                ...
                while (
                    ...
                    time.sleep(1)
                    NOD = RPA.ImgCheck(URL, r"\NoSinkoku.png", 0.9, 10)
                    if NOD[0] is True:
                        pg.press("return")
                        break
                if NOD[0] is False:
                ...
                if KJJ[0] is False:
                    ...
                    while (
                        ...
                        # 貸借エラーが表示されていないか確認
                        CE = RPA.ImgCheck(URL, r"\CalcErr.png", 0.9, 10)
                        if CE[0] is True:
                    ...
                    while (
                        ...
                        time.sleep(1)
                        KOW = RPA.ImgCheck(URL, r"\K_OverWrite2.png", 0.9, 10)
                        if KOW[0] is True:
                            pg.press("y")
                    # --------------------------------------------------------------------
                    time.sleep(4)
                ...
                while (
                    ...
                    time.sleep(1)
                    OVC = RPA.ImgCheck(URL, r"\K_OverWrite.png", 0.9, 10)
                    if OVC[0] is True:
                        pg.press("y")
                # ---------------------------------------------------------------------
                time.sleep(1)
