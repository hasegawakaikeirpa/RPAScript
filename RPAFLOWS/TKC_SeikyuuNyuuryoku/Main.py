...
class GUI(tk.Frame):
    def __init__(self, root):
        ...
        self.year = tk.Entry(
            self.inner_upfra, width=int(self.w / 5), textvariable=self.year_txt
        )
        ...
        self.month = tk.Entry(
            self.inner_upfra, width=int(self.w / 5), textvariable=self.month_txt
        )
        ...
        self.txt = tk.Entry(
            self.inner_lowerfra, width=int(self.w / 5), textvariable=self.save_dir
        )
