        ...
        while pg.locateOnScreen(FolURL2 + "/" + FileName, confidence=0.9) is None:
            ...
            if LogA[0] is True:
                ...
                while (
                    all(
                        pg.locateOnScreen(
                            FolURL2 + "/" + "DataIdouKakunin.png", confidence=0.9
                        )
                    )
                    is True
                ):
...
# ----------------------------------------------------------------------------------------------------------------------
def MaserFindSikibetu(
    MasterCSV, SyanaiCode, KeyCol, Col1, Col2, Col3, Col4, Col5, Col6
):
...
def OpenAction(LoopList, FolURL2, LogList):
    ...
    for LoopListItem in LoopList:
        ...
        while pg.locateOnScreen(FolURL2 + "/" + FileName, confidence=0.9) is None:
            ...
            conf = 0.9
            LoopVal = 10
            if ImgCheck(FolURL2, "PreMSG.png", conf, LoopVal)[0] is True:
                pg.press("return")
        ImgClick(FolURL2, FileName, conf, LoopVal)
        ...
        conf = 0.9
        LoopVal = 10
        if ImgCheck(FolURL2, "PDFReplace.png", conf, LoopVal)[0] is True:
            pg.press("y")
        time.sleep(1)
    ...
    for NoListItem in NoList:
        ...
        while pg.locateOnScreen(FolURL2 + "/" + FileName, confidence=0.9) is None:
            ...
            if NewEnt[0] is True:
                ...
                time.sleep(1)
                break
            elif DoubleOpen[0] is True:
                ImgClick(FolURL2, "DoubleOpen.png", conf, LoopVal)
                pg.press(["return"])
                while (
                    pg.locateOnScreen(FolURL2 + "/DoubleOpenNext.png", confidence=0.9)
                    is None
                ):
                    time.sleep(1)
                ...
                pg.press(["return"])
                break
        if NewEnt[0] is False and DoubleOpen[0] is False:
            ...
            if LoginErr is True:
                ...
                LoopVal = 100
                while (
                    pg.locateOnScreen(FolURL2 + "/MSGOKTrigger.png", confidence=0.9)
                    is None
                ):
                    time.sleep(1)
                ...
                if IA[0] is True:
                    ...
                    while (
                        pg.locateOnScreen(
                            FolURL2 + "/TihouzeiTab2.png", confidence=0.99999
                        )
                        is None
                    ):
                        time.sleep(1)
                        if ImgCheck(FolURL2, "KokuzeiTab.png", 0.9, 3)[0] is True:
                            IAOK = False
                            break
                    if IAOK is True:
                        ...
                        pg.write(
                            str(Lday[1]), interval=0.01
                        )  # 直接SENDできないのでpyautoguiで入力
                        pg.press("return")
                        time.sleep(1)
                        ...
                        FileName = "DataMoveCheck.png"
                        while (
                            pg.locateOnScreen(FolURL2 + "/" + FileName, confidence=0.9)
                            is None
                        ):
                            time.sleep(1)
                        FileName = "DataPCMMove.png"
...
PreList = []
NgLog = pd.read_csv(
    FolURL2 + "/RPAPhoto/TKC_PreSinkokuDown/Log/Log.csv", encoding="utf-8"
)
        ...
        if "プレ申告のお知らせ" in file_name or "プレ申告データに関するお知らせ" in file_name:
            ...
            for x in range(NgRow):
                ...
                if not Nos[0] == NgCodeCode:
                    ...
                    break
            if NoF is True:
                if os.path.exists(NewTitle) is False:
                    PreList.append(
                        [
