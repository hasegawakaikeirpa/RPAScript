    ...
    for SetListItem in SetList:
        if s_c != len(SetList) - 1:
            ...
            if len(InTotalList) != 0:
                ...
                rep = np.where(InTotalList[:, InTotalList.shape[1] - 1] == 100)
            ...
            if l_r != 0:
                ...
                if NPC[0] is True:
                    ...
                    if N_C >= 2:
                        ...
                        if len(Hukugou) != 0:
                            N_Arr = np.vstack([N_ArrHead, N_Arr[ind]])
                            # 日付文字列データの変換------------------------------------------
                            if (
                                "." in D_var
                                or "|" in D_var
                                ...
                                for np_hItem in reversed(np_h):
                                    if "一致率" == np_hItem:
                                        N_Arr = np.delete(N_Arr, np_h_c, 1)
                                    elif "日付一致率" == np_hItem:
                                        N_Arr = np.delete(N_Arr, np_h_c, 1)
                                ...
                                # ---------------------------------------------------
                                if l_r == 1:
                                    for l_s in range(len(N_Arr)):
                                        FinalList.append(list(N_Arr[l_s]))
                                else:
                                    for l_s in range(len(N_Arr)):
                                        if l_s != 0:
                                            FinalList.append(list(N_Arr[l_s]))
