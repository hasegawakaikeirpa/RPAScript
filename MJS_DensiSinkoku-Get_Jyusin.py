...
def PrintAct(FolURL2, C_SCode, C_Name, C_Nendo, C_Zeimoku, C_Syurui):
    ...
    if FC[0] is True:
        ...
        time.sleep(1)
        while (
            pg.locateOnScreen(FolURL2 + "/" + "MSEndGetJyusin.png", confidence=0.9)
            is None
        ):
            time.sleep(1)
        time.sleep(3)
        ...
        while (
            pg.locateOnScreen(FolURL2 + "/" + "PrintSyousai.png", confidence=0.9)
            is None
        ):
            time.sleep(1)
        ...
        ICFLCount = 0
        while (
            pg.locateOnScreen(FolURL2 + "/" + "SouRireList.png", confidence=0.9) is None
        ):
            time.sleep(1)
            ICFL = ImgCheckForList(FolURL2, PList, 0.9, 1)
            ImgClick(FolURL2, ICFL[1], 0.9, 1)
...
def MainStarter(FolURL2):
    ...
    TDS = (
        str(WaY.year)
        + str("{0:02d}".format(dt.today().month))
        + str("{0:02d}".format(dt.today().day - 1))
    )
    #############################################################################################################
...
def MainFirstAction(FolURL2, C_SCode, C_Name, C_Nendo, C_Zeimoku, C_Syurui):
    ...
    time.sleep(1)
    while (
        pg.locateOnScreen(FolURL2 + "/" + "SousinKekkaGetJyusin.png", confidence=0.9)
        is None
    ):
        time.sleep(1)
    if ImgCheck(FolURL2, "DoujiSousinGetJyusin.png", conf, LoopVal)[0] is True:
        ...
        if ListCheck[0] is True:
            for x in range(100):
                ...
                if ListCheck[0] is True:
                    ...
                    time.sleep(1)
                if ImgCheck(FolURL2, "FindCheckBoxNext.png", conf, LoopVal)[0] is False:
                    break
            time.sleep(1)
            pg.press("left")
            time.sleep(1)
