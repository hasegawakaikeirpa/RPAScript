...
static void createModuleCodeObjects(void) {
    ...
    codeobj_85368c9876f0a69c38f060b182551f9f = MAKE_CODEOBJECT(module_filename_obj, 210, CO_GENERATOR | CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[90], mod_consts[128], NULL, 1, 0, 0);
...
static PyObject *impl_numpy$core$_dtype$$$function__10__struct_dict_str(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        return NULL;
        outline_result_2:;
        tmp_iadd_expr_right_3 = UNICODE_JOIN(tmp_str_arg_value_2, tmp_iterable_value_2);
    ...
    }
    {
        ...
        return NULL;
        outline_result_3:;
        tmp_iadd_expr_right_5 = UNICODE_JOIN(tmp_str_arg_value_3, tmp_iterable_value_3);
    ...
    }
    {
        ...
        return NULL;
        outline_result_5:;
        tmp_iadd_expr_right_7 = UNICODE_JOIN(tmp_str_arg_value_4, tmp_iterable_value_4);
    ...
    branch_no_1:;
    {
        ...
        tmp_mod_expr_right_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_4, mod_consts[20]);
        if (tmp_mod_expr_right_1 == NULL) {
            assert(ERROR_OCCURRED());
...
static PyObject *impl_numpy$core$_dtype$$$function__11__is_packed(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_no_1:;
    {
        ...
        tmp_iadd_expr_right_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_4, mod_consts[20]);
        if (tmp_iadd_expr_right_1 == NULL) {
            assert(ERROR_OCCURRED());
