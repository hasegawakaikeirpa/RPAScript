...
static void createModuleCodeObjects(void) {
    ...
    codeobj_259784114d3c7d1b2c028c5a4bf66c9c = MAKE_CODEOBJECT(module_filename_obj, 142, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[75], mod_consts[126], NULL, 3, 0, 0);
}
...
static PyObject *impl_PIL$PcxImagePlugin$$$function__3__save(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        tmp_called_value_21 = LOOKUP_ATTRIBUTE(tmp_expression_value_21, mod_consts[63]);
        ...
        tmp_called_instance_2 = LOOKUP_ATTRIBUTE(tmp_expression_value_22, mod_consts[77]);
        if (tmp_called_instance_2 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    branch_yes_4:;
    {
        ...
        tmp_called_value_22 = LOOKUP_ATTRIBUTE(tmp_expression_value_24, mod_consts[63]);
        ...
        tmp_args_element_value_19 = CALL_FUNCTION_WITH_POSARGS1(tmp_called_value_23, mod_consts[76]);
    ...
    }
    {
        ...
        tmp_called_value_24 = LOOKUP_ATTRIBUTE(tmp_expression_value_25, mod_consts[63]);
