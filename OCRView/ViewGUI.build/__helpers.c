...
PyObject *CALL_FUNCTION_WITH_ARGS52(PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 52 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(function, args, 52);
        }
        ...
        if (method->m_object == NULL) {
            ...
            return Nuitka_CallFunctionPosArgs(method->m_function, args, 52);
        } else {
            if (unlikely(Py_EnterRecursiveCall((char *)" while calling a Python object"))) {
                return NULL;
            }
            ...
            if (function->m_args_simple && 52 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(function, method->m_object, args, 52);
            }
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs((struct Nuitka_FunctionObject const *)init_method, obj, args, 52);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS52(init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_METHOD_WITH_ARGS52(PyObject *source, PyObject *attr_name, PyObject *const *args) {
    CHECK_OBJECT(source);
    CHECK_OBJECT(attr_name);
        ...
        if (descr != NULL) {
            ...
            if (NuitkaType_HasFeatureClass(Py_TYPE(descr))) {
                ...
                if (func != NULL && PyDescr_IsData(descr)) {
                    ...
                    PyObject *result = CALL_FUNCTION_WITH_ARGS52(called_object, args)
;
                    Py_DECREF(called_object);
                    return result;
                }
...
;
        ...
        if (descr != NULL) {
            ...
            PyObject *result = CALL_FUNCTION_WITH_ARGS52(descr, args)
;
            Py_DECREF(descr);
            return result;
        }
