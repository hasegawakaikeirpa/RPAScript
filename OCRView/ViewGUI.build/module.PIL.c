...
// Mark the execution in the "__spec__" value.
    ...
    branch_yes_2:;
    {
        ...
        frame_cc2acdbc67f92788f061bda7b0fba939->m_frame.f_lineno = 74;
    ...
    branch_end_2:;
    {
        ...
        tmp_res = PyObject_SetItem(locals_PIL$$$class__1_UnidentifiedImageError_74, mod_consts[31], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(ERROR_OCCURRED());
        ...
        tmp_res = PyObject_SetItem(locals_PIL$$$class__1_UnidentifiedImageError_74, mod_consts[33], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(ERROR_OCCURRED());
        ...
        tmp_res = PyObject_SetItem(locals_PIL$$$class__1_UnidentifiedImageError_74, mod_consts[34], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(ERROR_OCCURRED());
