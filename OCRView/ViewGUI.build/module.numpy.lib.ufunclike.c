...
static PyCodeObject *codeobj_1a0df9ad86fba969de6f6dd7ade3a8bc;
static PyCodeObject *codeobj_8de261365263d7a2a4e284a73f37d1be;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_1a0df9ad86fba969de6f6dd7ade3a8bc = MAKE_CODEOBJECT(module_filename_obj, 199, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[63], mod_consts[71], NULL, 2, 0, 0);
    codeobj_8de261365263d7a2a4e284a73f37d1be = MAKE_CODEOBJECT(module_filename_obj, 127, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[62], mod_consts[71], NULL, 2, 0, 0);
}
...
static PyObject *impl_numpy$lib$ufunclike$$$function__6_isposinf(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_8de261365263d7a2a4e284a73f37d1be;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    ...
    PyObject *tmp_return_value = NULL;
    static struct Nuitka_FrameObject *cache_frame_8de261365263d7a2a4e284a73f37d1be = NULL;
    ...
    // Actual function body.
    // Tried code:
    if (isFrameUnusable(cache_frame_8de261365263d7a2a4e284a73f37d1be)) {
        Py_XDECREF(cache_frame_8de261365263d7a2a4e284a73f37d1be);

#if _DEBUG_REFCOUNTS
        if (cache_frame_8de261365263d7a2a4e284a73f37d1be == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_8de261365263d7a2a4e284a73f37d1be = MAKE_FUNCTION_FRAME(codeobj_8de261365263d7a2a4e284a73f37d1be, module_numpy$lib$ufunclike, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    }
    assert(cache_frame_8de261365263d7a2a4e284a73f37d1be->m_type_description == NULL);
    frame_8de261365263d7a2a4e284a73f37d1be = cache_frame_8de261365263d7a2a4e284a73f37d1be;

    // Push the new frame as the currently active one.
    pushFrameStack(frame_8de261365263d7a2a4e284a73f37d1be);

    // Mark the frame object as in use, ref count 1 will be up for reuse.
    assert(Py_REFCNT(frame_8de261365263d7a2a4e284a73f37d1be) == 2); // Frame stack
    ...
    // Framed code:
    {
        ...
        frame_8de261365263d7a2a4e284a73f37d1be->m_frame.f_lineno = 188;
    ...
    // Tried code:
    {
        ...
        CHECK_OBJECT(par_x);
        tmp_args_element_value_2 = par_x;
        frame_8de261365263d7a2a4e284a73f37d1be->m_frame.f_lineno = 190;
    ...
    if (exception_keeper_tb_1 == NULL) {
        exception_keeper_tb_1 = MAKE_TRACEBACK(frame_8de261365263d7a2a4e284a73f37d1be, exception_keeper_lineno_1);
    } else if (exception_keeper_lineno_1 != 0) {
        exception_keeper_tb_1 = ADD_TRACEBACK(exception_keeper_tb_1, frame_8de261365263d7a2a4e284a73f37d1be, exception_keeper_lineno_1);
    }
    ...
    // Tried code:
    {
        ...
        frame_8de261365263d7a2a4e284a73f37d1be->m_frame.f_lineno = 192;
    ...
    }
    {
        ...
        frame_8de261365263d7a2a4e284a73f37d1be->m_frame.f_lineno = 193;
        tmp_raise_type_1 = CALL_FUNCTION_WITH_SINGLE_ARG(PyExc_TypeError, tmp_make_exception_arg_1);
        Py_DECREF(tmp_make_exception_arg_1);
        assert(!(tmp_raise_type_1 == NULL));
        CHECK_OBJECT(var_e);
    ...
    if (exception_tb && exception_tb->tb_frame == &frame_8de261365263d7a2a4e284a73f37d1be->m_frame) frame_8de261365263d7a2a4e284a73f37d1be->m_frame.f_lineno = exception_tb->tb_lineno;
    type_description_1 = "oooooo";
    goto try_except_handler_3;
    branch_end_1:;
    NUITKA_CANNOT_GET_HERE("tried codes exits in all cases");
    ...
    try_end_1:;
    {
        ...
        frame_8de261365263d7a2a4e284a73f37d1be->m_frame.f_lineno = 196;
        {
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_8de261365263d7a2a4e284a73f37d1be);
#endif
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_8de261365263d7a2a4e284a73f37d1be, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_8de261365263d7a2a4e284a73f37d1be->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_8de261365263d7a2a4e284a73f37d1be, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_8de261365263d7a2a4e284a73f37d1be,
        type_description_1,
        par_x,
        par_out,
        var_is_inf,
    ...
    // Release cached frame if used for exception.
    if (frame_8de261365263d7a2a4e284a73f37d1be == cache_frame_8de261365263d7a2a4e284a73f37d1be) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif

        Py_DECREF(cache_frame_8de261365263d7a2a4e284a73f37d1be);
        cache_frame_8de261365263d7a2a4e284a73f37d1be = NULL;
    }

    assertFrameObject(frame_8de261365263d7a2a4e284a73f37d1be);
...
static PyObject *impl_numpy$lib$ufunclike$$$function__7_isneginf(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    PyObject *var_e = NULL;
    PyObject *var_dtype = NULL;
    struct Nuitka_FrameObject *frame_1a0df9ad86fba969de6f6dd7ade3a8bc;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    ...
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_3;
    PyObject *tmp_return_value = NULL;
    static struct Nuitka_FrameObject *cache_frame_1a0df9ad86fba969de6f6dd7ade3a8bc = NULL;
    PyObject *exception_keeper_type_4;
    PyObject *exception_keeper_value_4;
    PyTracebackObject *exception_keeper_tb_4;
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_4;
    ...
    // Actual function body.
    // Tried code:
    if (isFrameUnusable(cache_frame_1a0df9ad86fba969de6f6dd7ade3a8bc)) {
        Py_XDECREF(cache_frame_1a0df9ad86fba969de6f6dd7ade3a8bc);

#if _DEBUG_REFCOUNTS
        if (cache_frame_1a0df9ad86fba969de6f6dd7ade3a8bc == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_1a0df9ad86fba969de6f6dd7ade3a8bc = MAKE_FUNCTION_FRAME(codeobj_1a0df9ad86fba969de6f6dd7ade3a8bc, module_numpy$lib$ufunclike, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    }
    assert(cache_frame_1a0df9ad86fba969de6f6dd7ade3a8bc->m_type_description == NULL);
    frame_1a0df9ad86fba969de6f6dd7ade3a8bc = cache_frame_1a0df9ad86fba969de6f6dd7ade3a8bc;

    // Push the new frame as the currently active one.
    pushFrameStack(frame_1a0df9ad86fba969de6f6dd7ade3a8bc);

    // Mark the frame object as in use, ref count 1 will be up for reuse.
    assert(Py_REFCNT(frame_1a0df9ad86fba969de6f6dd7ade3a8bc) == 2); // Frame stack
    ...
    // Framed code:
    {
        ...
        CHECK_OBJECT(par_x);
        tmp_args_element_value_1 = par_x;
        frame_1a0df9ad86fba969de6f6dd7ade3a8bc->m_frame.f_lineno = 260;
        tmp_assign_source_1 = CALL_METHOD_WITH_SINGLE_ARG(tmp_called_instance_1, mod_consts[34], tmp_args_element_value_1);
        if (tmp_assign_source_1 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    // Tried code:
    {
        ...
        CHECK_OBJECT(par_x);
        tmp_args_element_value_2 = par_x;
        frame_1a0df9ad86fba969de6f6dd7ade3a8bc->m_frame.f_lineno = 262;
    ...
    if (exception_keeper_tb_1 == NULL) {
        exception_keeper_tb_1 = MAKE_TRACEBACK(frame_1a0df9ad86fba969de6f6dd7ade3a8bc, exception_keeper_lineno_1);
    } else if (exception_keeper_lineno_1 != 0) {
        exception_keeper_tb_1 = ADD_TRACEBACK(exception_keeper_tb_1, frame_1a0df9ad86fba969de6f6dd7ade3a8bc, exception_keeper_lineno_1);
    }
    ...
    // Tried code:
    {
        ...
        CHECK_OBJECT(par_x);
        tmp_args_element_value_3 = par_x;
        frame_1a0df9ad86fba969de6f6dd7ade3a8bc->m_frame.f_lineno = 264;
        tmp_expression_value_1 = CALL_METHOD_WITH_SINGLE_ARG(tmp_called_instance_3, mod_consts[24], tmp_args_element_value_3);
        if (tmp_expression_value_1 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        frame_1a0df9ad86fba969de6f6dd7ade3a8bc->m_frame.f_lineno = 265;
        tmp_raise_type_1 = CALL_FUNCTION_WITH_SINGLE_ARG(PyExc_TypeError, tmp_make_exception_arg_1);
        Py_DECREF(tmp_make_exception_arg_1);
        assert(!(tmp_raise_type_1 == NULL));
        CHECK_OBJECT(var_e);
    ...
    if (exception_tb && exception_tb->tb_frame == &frame_1a0df9ad86fba969de6f6dd7ade3a8bc->m_frame) frame_1a0df9ad86fba969de6f6dd7ade3a8bc->m_frame.f_lineno = exception_tb->tb_lineno;
    type_description_1 = "oooooo";
    goto try_except_handler_3;
    branch_end_1:;
    NUITKA_CANNOT_GET_HERE("tried codes exits in all cases");
    ...
    try_end_1:;
    {
        ...
        CHECK_OBJECT(par_out);
        tmp_args_element_value_6 = par_out;
        frame_1a0df9ad86fba969de6f6dd7ade3a8bc->m_frame.f_lineno = 268;
        {
            PyObject *call_args[] = {tmp_args_element_value_4, tmp_args_element_value_5, tmp_args_element_value_6};
            tmp_return_value = CALL_METHOD_WITH_ARGS3(
                tmp_called_instance_4,
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_1a0df9ad86fba969de6f6dd7ade3a8bc);
#endif
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_1a0df9ad86fba969de6f6dd7ade3a8bc, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_1a0df9ad86fba969de6f6dd7ade3a8bc->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_1a0df9ad86fba969de6f6dd7ade3a8bc, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_1a0df9ad86fba969de6f6dd7ade3a8bc,
        type_description_1,
        par_x,
        par_out,
        var_is_inf,
    ...
    // Release cached frame if used for exception.
    if (frame_1a0df9ad86fba969de6f6dd7ade3a8bc == cache_frame_1a0df9ad86fba969de6f6dd7ade3a8bc) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif

        Py_DECREF(cache_frame_1a0df9ad86fba969de6f6dd7ade3a8bc);
        cache_frame_1a0df9ad86fba969de6f6dd7ade3a8bc = NULL;
    }

    assertFrameObject(frame_1a0df9ad86fba969de6f6dd7ade3a8bc);
...
static PyObject *MAKE_FUNCTION_numpy$lib$ufunclike$$$function__6_isposinf(PyObject *defaults) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_8de261365263d7a2a4e284a73f37d1be,
        defaults,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
...
static PyObject *MAKE_FUNCTION_numpy$lib$ufunclike$$$function__7_isneginf(PyObject *defaults) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_1a0df9ad86fba969de6f6dd7ade3a8bc,
        defaults,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
