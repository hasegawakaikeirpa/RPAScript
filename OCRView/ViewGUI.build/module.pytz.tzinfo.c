...
static PyCodeObject *codeobj_fef6ef1a87a4f806db6ba59060626145;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_fef6ef1a87a4f806db6ba59060626145 = MAKE_CODEOBJECT(module_filename_obj, 368, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[147], mod_consts[148], NULL, 1, 0, 0);
...
static PyObject *impl_pytz$tzinfo$$$function__17_localize(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_1;
    PyObject *tmp_return_value = NULL;
    struct Nuitka_FrameObject *frame_fef6ef1a87a4f806db6ba59060626145_2;
    ...
    PyTracebackObject *exception_keeper_tb_2;
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_2;
    static struct Nuitka_FrameObject *cache_frame_fef6ef1a87a4f806db6ba59060626145_2 = NULL;
    PyObject *exception_keeper_type_3;
    PyObject *exception_keeper_value_3;
    PyTracebackObject *exception_keeper_tb_3;
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_3;
    ...
    branch_no_7:;
    {
        ...
        if (isFrameUnusable(cache_frame_fef6ef1a87a4f806db6ba59060626145_2)) {
            Py_XDECREF(cache_frame_fef6ef1a87a4f806db6ba59060626145_2);

#if _DEBUG_REFCOUNTS
            if (cache_frame_fef6ef1a87a4f806db6ba59060626145_2 == NULL) {
                count_active_frame_cache_instances += 1;
            } else {
                count_released_frame_cache_instances += 1;
            }
            count_allocated_frame_cache_instances += 1;
#endif
            cache_frame_fef6ef1a87a4f806db6ba59060626145_2 = MAKE_FUNCTION_FRAME(codeobj_fef6ef1a87a4f806db6ba59060626145, module_pytz$tzinfo, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
        } else {
            count_hit_frame_cache_instances += 1;
#endif
        }
        assert(cache_frame_fef6ef1a87a4f806db6ba59060626145_2->m_type_description == NULL);
        frame_fef6ef1a87a4f806db6ba59060626145_2 = cache_frame_fef6ef1a87a4f806db6ba59060626145_2;

        // Push the new frame as the currently active one.
        pushFrameStack(frame_fef6ef1a87a4f806db6ba59060626145_2);

        // Mark the frame object as in use, ref count 1 will be up for reuse.
        assert(Py_REFCNT(frame_fef6ef1a87a4f806db6ba59060626145_2) == 2); // Frame stack
...
#if 0
        RESTORE_FRAME_EXCEPTION(frame_fef6ef1a87a4f806db6ba59060626145_2);
#endif
        ...
        if (exception_tb == NULL) {
            exception_tb = MAKE_TRACEBACK(frame_fef6ef1a87a4f806db6ba59060626145_2, exception_lineno);
        } else if (exception_tb->tb_frame != &frame_fef6ef1a87a4f806db6ba59060626145_2->m_frame) {
            exception_tb = ADD_TRACEBACK(exception_tb, frame_fef6ef1a87a4f806db6ba59060626145_2, exception_lineno);
        }

        // Attaches locals to frame if any.
        Nuitka_Frame_AttachLocals(
            frame_fef6ef1a87a4f806db6ba59060626145_2,
            type_description_2,
            outline_0_var_p,
            par_is_dst
        );
        ...
        // Release cached frame if used for exception.
        if (frame_fef6ef1a87a4f806db6ba59060626145_2 == cache_frame_fef6ef1a87a4f806db6ba59060626145_2) {
#if _DEBUG_REFCOUNTS
            count_active_frame_cache_instances -= 1;
            count_released_frame_cache_instances += 1;
#endif

            Py_DECREF(cache_frame_fef6ef1a87a4f806db6ba59060626145_2);
            cache_frame_fef6ef1a87a4f806db6ba59060626145_2 = NULL;
        }

        assertFrameObject(frame_fef6ef1a87a4f806db6ba59060626145_2);
