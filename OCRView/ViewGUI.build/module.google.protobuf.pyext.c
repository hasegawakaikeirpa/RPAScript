...
static PyCodeObject *codeobj_8505f3c4e0ecc688f93740e6b79d6ccc;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[19]); CHECK_OBJECT(module_filename_obj);
    codeobj_8505f3c4e0ecc688f93740e6b79d6ccc = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[20], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_8505f3c4e0ecc688f93740e6b79d6ccc;
    ...
    // Frame without reuse.
    frame_8505f3c4e0ecc688f93740e6b79d6ccc = MAKE_MODULE_FRAME(codeobj_8505f3c4e0ecc688f93740e6b79d6ccc, module_google$protobuf$pyext);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_8505f3c4e0ecc688f93740e6b79d6ccc);
    assert(Py_REFCNT(frame_8505f3c4e0ecc688f93740e6b79d6ccc) == 2);
    ...
    // Framed code:
    {
        ...
        frame_8505f3c4e0ecc688f93740e6b79d6ccc->m_frame.f_lineno = 1;
        {
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_8505f3c4e0ecc688f93740e6b79d6ccc);
#endif
    popFrameStack();

    assertFrameObject(frame_8505f3c4e0ecc688f93740e6b79d6ccc);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_8505f3c4e0ecc688f93740e6b79d6ccc, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_8505f3c4e0ecc688f93740e6b79d6ccc->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_8505f3c4e0ecc688f93740e6b79d6ccc, exception_lineno);
    }
